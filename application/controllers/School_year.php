...
class School_year extends REST_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('School_year_model', 'school_year_model');
    ...
    public function fetch_get()
    {
        ...
        if ($auth['status'])
        {
            $api_res = $this->school_year_model->fetch($this->input->get());
        }
        else
        {
            $api_res = $auth;
    ...
    public function insert_post()
    {
        ...
        if ($auth['status'])
        {
            ...
            $api_res = $this->school_year_model->insert($posts);
    ...
    public function update_post()
    {
        ...
        if ($auth['status'])
        {
            ...
            $api_res = $this->school_year_model->update($posts);
    ...
    public function delete_post()
    {
        ...
        if ($auth['status'])
        {
            ...
            $api_res = $this->school_year_model->delete($this->input->post());
