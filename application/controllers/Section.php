...
class Section extends REST_Controller
{
    ...
    public function fetch_get()
    {
        ...
        if ($auth['status'])
        {
            $api_res = $this->section_model->fetch($this->input->get());
        }
        else
        {
            $api_res = $auth;
    ...
    public function insert_post()
    {
        ...
        if ($auth['status'])
        {
            ...
            $api_res = $this->section_model->insert($posts);
    ...
    public function update_post()
    {
        ...
        if ($auth['status'])
        {
            ...
            $api_res = $this->section_model->update($posts);
    ...
    public function delete_post()
    {
        ...
        if ($auth['status'])
        {
            $api_res = $this->section_model->delete($this->input->post());
